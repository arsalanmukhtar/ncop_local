...
export const ncop_menu_items = {
  recent_hazard_events: {
    "Alerts": {
      static: {
        ...
        // Add this to the recent_hazard_events > Alerts > static section, after the gdacs_dr_events
        usgs_realtime_eq_events: {
          ...
          source: {
            ...
            type: "geojson",
            data: `https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=${getNextNDays(-10)}T19:00:00`,
          },
          layers: [
            {
              id: "usgs_realtime_eq_events_point",
              type: "circle",
              source: "usgs_realtime_eq_events",
              paint: {
                "circle-radius": 5,
                ...
                "circle-color": [
                  ...
                  ["<", ["get", "mag"], 3],
                  "#A8A8A8",
                  ["all", [">=", ["get", "mag"], 3], ["<=", ["get", "mag"], 4.5]],
                  "#75E9E6",
                  ["all", [">=", ["get", "mag"], 4.6], ["<=", ["get", "mag"], 6]],
                  "#F1E757",
                  ["all", [">=", ["get", "mag"], 6.1], ["<=", ["get", "mag"], 7.4]],
                  "#F7151F",
                  "#000000",
                ],
              },
          ...
          legend: true,
          legendPath: getLegendImage("USGS_Earthquakes.webp"),
          information:
            "Displays real-time USGS Earthquake events from the last 10 days. Circle color indicates magnitude: Gray (<3), Cyan (3-4.5), Yellow (4.6-6), Red (6.1-7.4), Black (>7.5).",
        },
      },
    },
  },
    ...
    "Real Time Air Quality Parameters": {
      ...
      toggle: {
        waqi_stations_asia: {
          label: "🌏 WAQI - Asia",
          source: {
            id: "waqi_stations_asia-source",
            type: "geojson",
            data: `${baseUrl}/get-waqi-global-airquality/?regions=asia`,
            maxzoom: 22,
          },
          layers: [
            {
              id: "waqi_stations_asia-circle",
              type: "circle",
              source: "waqi_stations_asia-source",
              paint: {
                "circle-radius": [
                  "interpolate",
                  ["linear"],
            ...
            },
            {
              ...
              paint: {
                ...
                "circle-color": [
                  ...
                  ["get", "aqi"],
                  "rgba(0,228,0,0.15)",
                  51, "rgba(255,255,0,0.18)",
                  101, "rgba(255,126,0,0.22)",
                  151, "rgba(255,0,0,0.25)",
                  201, "rgba(143,63,151,0.28)",
                  301, "rgba(126,0,35,0.32)",
                ],
                "circle-blur": 1.2,
                "circle-opacity": 0.6,
              },
          ...
          information: "Real-time air quality data for Asia from the World Air Quality Index (WAQI) project.",
        },

        waqi_stations_europe: {
          label: "🌍 WAQI - Europe",
          source: {
            id: "waqi_stations_europe-source",
            type: "geojson",
            data: `${baseUrl}/get-waqi-global-airquality/?regions=europe`,
            maxzoom: 22,
          },
          layers: [
            {
              id: "waqi_stations_europe-circle",
              type: "circle",
              source: "waqi_stations_europe-source",
              paint: {
                "circle-radius": [
                  "interpolate",
                  ["linear"],
          ...
          legend: true,
          legendPath: getLegendImage("World_AirQuality.webp"),
          information: "Real-time air quality data for Europe from the World Air Quality Index (WAQI) project.",
        },

        waqi_stations_africa: {
          label: "🌍 WAQI - Africa",
          source: {
            id: "waqi_stations_africa-source",
            type: "geojson",
            data: `${baseUrl}/get-waqi-global-airquality/?regions=africa`,
            maxzoom: 22,
          },
          layers: [
            {
              id: "waqi_stations_africa-circle",
              type: "circle",
              source: "waqi_stations_africa-source",
              paint: {
                "circle-radius": [
                  "interpolate",
                  ["linear"],
          ...
          legend: true,
          legendPath: getLegendImage("World_AirQuality.webp"),
          information: "Real-time air quality data for Africa from the World Air Quality Index (WAQI) project.",
        },

        waqi_stations_north_america: {
          label: "🌎 WAQI - North America",
          source: {
            id: "waqi_stations_north_america-source",
            type: "geojson",
            data: `${baseUrl}/get-waqi-global-airquality/?regions=north_america`,
            maxzoom: 22,
          },
          layers: [
            {
              id: "waqi_stations_north_america-circle",
              type: "circle",
              source: "waqi_stations_north_america-source",
              paint: {
                "circle-radius": [
                  "interpolate",
                  ["linear"],
            ...
            {
              id: "waqi_stations_north_america-glow",
              type: "circle",
              source: "waqi_stations_north_america-source",
              paint: {
                "circle-radius": [
            ...
            {
              id: "waqi_stations_north_america-label",
              type: "symbol",
              source: "waqi_stations_north_america-source",
              minzoom: 4,
              paint: {
          ...
          legend: true,
          legendPath: getLegendImage("World_AirQuality.webp"),
          information: "Real-time air quality data for North America from the World Air Quality Index (WAQI) project.",
        },

        waqi_stations_south_america: {
          label: "🌎 WAQI - South America",
          source: {
            id: "waqi_stations_south_america-source",
            type: "geojson",
            data: `${baseUrl}/get-waqi-global-airquality/?regions=south_america`,
            maxzoom: 22,
          },
          layers: [
            {
              id: "waqi_stations_south_america-circle",
              type: "circle",
              source: "waqi_stations_south_america-source",
              paint: {
                "circle-radius": [
                  "interpolate",
                  ["linear"],
            ...
            {
              id: "waqi_stations_south_america-glow",
              type: "circle",
              source: "waqi_stations_south_america-source",
              paint: {
                "circle-radius": [
            ...
            {
              id: "waqi_stations_south_america-label",
              type: "symbol",
              source: "waqi_stations_south_america-source",
              minzoom: 4,
              paint: {
          ...
          legend: true,
          legendPath: getLegendImage("World_AirQuality.webp"),
          information: "Real-time air quality data for South America from the World Air Quality Index (WAQI) project.",
        },

        waqi_stations_oceania: {
          label: "🌏 WAQI - Oceania",
          source: {
            id: "waqi_stations_oceania-source",
            type: "geojson",
            data: `${baseUrl}/get-waqi-global-airquality/?regions=oceania`,
            maxzoom: 22,
          },
          layers: [
            {
              id: "waqi_stations_oceania-circle",
              type: "circle",
              source: "waqi_stations_oceania-source",
              paint: {
                "circle-radius": [
                  "interpolate",
                  ["linear"],
            ...
            {
              id: "waqi_stations_oceania-label",
              type: "symbol",
              source: "waqi_stations_oceania-source",
              minzoom: 4,
              paint: {
          ...
          legend: true,
          legendPath: getLegendImage("World_AirQuality.webp"),
          information: "Real-time air quality data for Oceania from the World Air Quality Index (WAQI) project.",
        },

        waqi_stations_middle_east: {
          label: "🌍 WAQI - Middle East",
          source: {
            id: "waqi_stations_middle_east-source",
            type: "geojson",
            data: `${baseUrl}/get-waqi-global-airquality/?regions=middle_east`,
            maxzoom: 22,
          },
          layers: [
            {
              id: "waqi_stations_middle_east-circle",
              type: "circle",
              source: "waqi_stations_middle_east-source",
              paint: {
                "circle-radius": [
                  "interpolate",
                  ["linear"],
            ...
            {
              id: "waqi_stations_middle_east-glow",
              type: "circle",
              source: "waqi_stations_middle_east-source",
              paint: {
                "circle-radius": [
            ...
            {
              id: "waqi_stations_middle_east-label",
              type: "symbol",
              source: "waqi_stations_middle_east-source",
              minzoom: 4,
              paint: {
          ...
          legend: true,
          legendPath: getLegendImage("World_AirQuality.webp"),
          information: "Real-time air quality data for Middle East from the World Air Quality Index (WAQI) project.",
        },
      },
    }
  },
  ...
  //     },
  //     // toggle: {
  //     //   // COMPLETE WAQI LAYER WITH CLUSTERING
  //     //   // Replace your entire waqi_stations configuration with this:
  ...
  //     //   //     // Calculate max AQI in each cluster for coloring
  //     //   //     clusterProperties: {
  //     //   //       maxAqi: ["max", ["get", "aqi"]]
  //     //   //     }
  //     //   //   },
  ...
  //     //   //   layers: [
  //     //   //     // ═══════════════════════════════════════════════════
  //     //   //     // CLUSTER LAYERS (shown when points are grouped)
  //     //   //     // ═══════════════════════════════════════════════════

  //     //   //     // Cluster background glow
  //     //   //     {
  //     //   //       id: "waqi_stations-cluster-glow",
  //     //   //       type: "circle",
  ...
  //     //   //     {
  //     //   //       id: "waqi_stations-clusters",
  //     //   //       type: "circle",
  //     //   //       source: "waqi_stations-source",
  //     //   //       filter: ["has", "point_count"], // ⭐ ONLY CLUSTERS
  //     //   //       paint: {
  //     //   //         // Size by number of stations
  //     //   //         "circle-radius": [
  //     //   //           "step",
  //     //   //           ["get", "point_count"],
  //     //   //           20,    // 1-99 stations
  ...
  //     //   //     // Cluster count label
  //     //   //     {
  //     //   //       id: "waqi_stations-cluster-count",
  //     //   //       type: "symbol",
  //     //   //       source: "waqi_stations-source",
  //     //   //       filter: ["has", "point_count"], // ⭐ ONLY CLUSTERS
  //     //   //       layout: {
  ...
  //     //   //     // ═══════════════════════════════════════════════════
  //     //   //     // UNCLUSTERED LAYERS (individual stations)
  //     //   //     // ═══════════════════════════════════════════════════

  //     //   //     // Individual station glow
  //     //   //     {
  ...
  //     //   //   legend: true,
  //     //   //   legendPath: getLegendImage("World_AirQuality.webp"),
  //     //   //   information: "The WAQI-Stations Air Quality layer displays real-time air quality data from the World Air Quality Index (WAQI) project. Click clusters to zoom in and see individual stations."
  //     //   // }
  //     // },
  //   },
  // },
